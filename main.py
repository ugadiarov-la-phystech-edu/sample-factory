...
from crafter_baseline.utils.config_validation import Experiment
from crafter_baseline.utils.gs2dict import generate_variants
import yaml
...
def start_training_runs(config_path):
    ...
    for resolved_vars, spec in generate_variants(config):
        ...
        cmd = f"python3 crafter_baseline/training_run.py --wandb_thread_mode=True --raw_config='{json.dumps(spec)}'"
